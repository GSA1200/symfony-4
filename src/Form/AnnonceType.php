...
class AnnonceType extends ApplicationType
{
    ...
    {
        $builder
                ->add('title', TextType::class, $this->getConfiguration("Titre", "Saisissez un super titre !"))
                ...
                ->add('coverImage', UrlType::class,$this->getConfiguration("URL de l'image principale",
                        "Donnez l'adresse de l'image qui donne vraiment envie"))
                ...
                ->add('content', TextareaType::class, $this->getConfiguration("Description détaillée",
                        "Saisissez une description qui donne vraiment envie de venir chez vous !"))
